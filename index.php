		...
		<div>
			...
			<div id="content">
				...
				<div id='datesmenu' class="wow zoomIn">
					...
					<div class='test wow fadeInUp' id="target2" value="Month" data-wow-delay='0.3s'><span>Month</span></div>
					<div class='test wow fadeInUp' id="target1" value="Year" data-wow-delay='0.4s'><span>Year</span></div>
				</div>
